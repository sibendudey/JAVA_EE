...
<html>
  <head>  
    <title> Spittr revisited with Angular!!! </title>  
    <style>
      .username.ng-valid {
      ...
      .firstname.ng-dirty.ng-invalid-email {
          background-color: yellow;
      }
                  ...
                  <form ng-submit="ctrl.submit()" name="myForm" class="form-horizontal">
                      ...
                      <div class="row">
                          <div class="form-group col-md-12">
                              ...
                              <div class="col-md-7">
                                  <input type="text" ng-model="ctrl.spitter.firstName" id="firstname" class="firstname form-control input-sm" placeholder="Enter your first name" required ng-minlength="3"/>
                       ...
                       <div class="row">
                          <div class="form-group col-md-12">
                              ...
                              <div class="col-md-7">
                                  <input type="text" ng-model="ctrl.spitter.lastName" id="lastname" class="lastname form-control input-sm" placeholder="Enter your last name " required ng-minlength="3"/>
                                  <div class="has-error" ng-show="myForm.$dirty">
